...
import { WhoHorizontalDossier } from './WhoHorizontalDossier';
import { WhatWeMakeBlurSection } from './WhatWeMakeBlurSection';
import './who.css';
 ...
 * dossier (mission, vision, promise, capabilities) → output register.
...
export const WhoWeAreSection = () => {
  ...
  return (
    <section className="who-root" ref={rootRef}>
      ...
      {/* ============ HORIZONTAL SYSTEM DOSSIER ============ */}
      <WhoHorizontalDossier />

      {/* ============ WHAT WE MAKE / FOCUS REGISTER ============ */}
      <WhatWeMakeBlurSection />
    </section>
  );
};
